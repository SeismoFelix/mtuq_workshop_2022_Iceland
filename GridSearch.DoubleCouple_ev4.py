...
if __name__=='__main__':
    ...
    path_data=    fullpath('data/examples/20140825161903000/*.[zrt]')
    path_weights= fullpath('data/examples/20140825161903000/weights.dat')
    ...
    origin = Origin({
        'time': '2014-08-25T16:19:03.00000Z',
        'latitude': 64.612,
        'longitude': -17.472,
        'depth_in_m': 5000.0,
        })
